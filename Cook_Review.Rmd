...
# Hi Maggie, Great job on  the assignment. I only have a few suggestions and they are made within.
...
# I like your approach here to merge the files. For me, however I like having  the SNP_ID's out of the row name columns in it's own file allowing to work with it in the future if I need it. Below is the code for that:
